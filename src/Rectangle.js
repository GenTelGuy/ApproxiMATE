...
Rectangle.prototype = 
{
	...
	draw: function( canvas )
	{
		...
		var topY = centerY - this.height/2;//Determines the positions of the rectangle's edges
		var bottomY = centerY + this.height/2;
		
		var leftX = centerX - this.width/2;
		var rightX = centerX + this.width/2;
